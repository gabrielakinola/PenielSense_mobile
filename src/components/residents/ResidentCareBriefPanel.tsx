  ...
  return (
    <View style={{ gap: 16 }}>
      ...
      <Animated.View entering={FadeInDown.delay(60).duration(400)}>
        ...
        <Card>
          <Text
            style={{ ...typography.body, color: colors.text, lineHeight: 23 }}
          >
            {brief.currentSummary}
          </Text>
          {brief.baselineReliability ? (
            ...
            >
              <Text style={{ ...typography.label, color: colors.secondary }}>
                {brief.baselineReliability.label}
              </Text>
            </View>
          ) : null}
          <Pressable
            ...
            >
              {brief.baselineReliability ? (
                <View>
                  ...
                  >
                    {brief.baselineReliability.description}
                  </Text>
                </View>
              ) : null}
              {(brief.why ?? []).map((reason) => (
                <View
                  key={reason.id}
                  style={{
                    padding: 10,
      ...
      <Animated.View entering={FadeInDown.delay(100).duration(400)}>
        {(brief.observationBundles?.length ?? 0) > 0 ? (
          <>
            <SectionHeader title="What needs your attention" />
            <View style={{ gap: 10 }}>
              {brief.observationBundles!.map((bundle) => (
                <Card
                  key={bundle.id}
                  style={{
                    borderLeftWidth: 3,
                ...
                >
                  ...
                  >
                    <Eye size={18} color={colors.status.watch} />
                    <Text
                      style={{
                  ...
                  >
                    Based on: {bundle.sourceAreas.join(" + ")}
                  </Text>
                </Card>
              ))}
            </View>
